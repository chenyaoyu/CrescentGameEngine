...
void EditorApp::createSwapChain(bool enableVsync) {
...
void EditorApp::createImageViews() {
...
void EditorApp::createGraphicsPipeline() {
	auto vertShaderCode = readFile("F:/CrescentGameEngine/CrescentGameEngine/CrescentGameEngine/x64/Debug/spr_v/test.vert.spv");
	auto fragShaderCode = readFile("F:/CrescentGameEngine/CrescentGameEngine/CrescentGameEngine/x64/Debug/spr_v/test.frag.spv");
...
std::vector<char> EditorApp::readFile(const std::string& filename) {
...
VkShaderModule EditorApp::createShaderModule(const std::vector<char>& code) {
...
void EditorApp::createRenderPass() {
...
void EditorApp::createFramebuffers() {
...
void EditorApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void EditorApp::createCommandPool() {
...
void EditorApp::createCommandBuffer() {
...
void EditorApp::createSyncObjects() {
